...
const translations = defineMessages({
  addSuccess: {
    ...
    defaultMessage: '{forum} have been added to knowledge base.',
  },
  addFailure: {
  ...
  removeSuccess: {
    ...
    defaultMessage: '{forum} have been removed from knowledge base.',
  },
  removeFailure: {
  ...
  const onImport = (): Promise<void> => {
    ...
    return dispatch(
      importForum(
        ...
        () => {
          setIsLoading(false);
          toastInstance.error(t(translations.addFailure));
        },
      ),
    );
  };
    ...
    return dispatch(destroyImportedDiscussions(importedForumImportIds))
      ...
      .catch((error) => {
        const errorMessage = error.response?.data?.errors
          ...
          : '';
        toast.error(`${t(translations.removeFailure)} - ${errorMessage}`);
        throw error;
      })
      .finally(() => {
        setIsLoading(false);
