...
ActiveRecord::Schema[7.2].define(version: 2024_12_03_152111) do
  ...
  create_table "course_material_text_chunkings", id: :serial, force: :cascade do |t|
    ...
    t.uuid "job_id"
    t.index ["job_id"], name: "fk__course_material_text_chunkings_on_job_id", unique: true
    t.index ["material_id"], name: "fk__course_material_text_chunkings_on_material_id", unique: true
  end
